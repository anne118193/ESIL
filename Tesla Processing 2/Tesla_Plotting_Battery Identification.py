...
#summary_file = r'/Users/ITSloaner/Downloads/Tesla Processing/Tesla_test_summary.xlsx'  #use for cycle aging
summary_file = r'/Users/ITSloaner/Downloads/Tesla Processing/Tesla_test_summary_battery_identification.xlsx' #use for battery identification/characterization
summary_file2 = r'/Users/ITSloaner/Downloads/Tesla Processing/Tesla_Historic.xlsx'
...
outpath = r'/Users/ITSloaner/Downloads/Tesla Processing/'    # path for saving plot
...
#idx2 = summary_data.columns.get_loc("cell_18") #uncomment for full cycle aging
idx3 = summary_data.columns.get_loc("cell_6")
#idx4 = summary_data.columns.get_loc("cell_12") #uncomment for full cycle aging
