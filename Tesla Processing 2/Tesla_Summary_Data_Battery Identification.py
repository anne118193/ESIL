...
summary_file = r'/Users/ITSloaner/Downloads/Tesla Processing/Historic_Summary.csv'
...
# name of csv file
#data_file = r'Tesla_Aging_28.csv' #uncomment when processing aging
#data_file_path = path + data_file  #uncomment for aging
...
EOLparam(data_file_path, cell_num, summary_file)   #uncomment when processing aging
...
print('done with Tesla_Summary_Data')