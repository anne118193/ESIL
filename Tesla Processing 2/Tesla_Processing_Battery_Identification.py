...
def getAhAndCaps(data_file_path, cell_num, soc_curve_file, summary_file, cc, isCalendarAging=False):
    ...
    start_idx = 16
    end_idx = start_idx + 6
    StartVs = cell_voltages[int(Step[start_idx] - 1),
              :]  # get the voltage at the height of the CCCV curve after constant voltage
    EndVs = cell_voltages[int(Step[end_idx] - 1),
            :]  # get the voltage at the end of the CCCV curve after constant current discharge
    ...
    print("capacity of each cell: ", Cap)
    # determine test name
    ...
    #    summary_updated = np.concatenate(
    #        [np.array([test_name, end_date.strftime('%Y-%m-%d '), days_elapsed, DCH1, DCH2]), Cap])
...
summary_file = r'/Users/ITSloaner/Downloads/Tesla Processing/Tesla_test_summary_battery_identification.csv'
...
#cell_num=6     #battery identification/characterization (only has 6 cells)
...
path = r'/Users/ITSloaner/Downloads/Tesla Processing 2/'
# path = r'F:/Tesla Data/'
# name of csv file
...
#data_file_path = r'/Users/ITSloaner/Downloads/Tesla Processing 2/cellvoltages_2022-07-15-16-59-47_T-13_Char.csv'
#data_file_path = r'/Users/ITSloaner/Downloads/Tesla Processing 2/cellvoltages_2022-07-08-11-17-44_T-1_Char_redo4.csv'
data_file_path = r'/Users/ITSloaner/Downloads/Tesla Processing 2/cellvoltages_2022-05-07-16-39-26-T1-7-2-6_Aging28.csv'
#
...
# data_file_path = r'/Users/ITSloaner/Downloads/Tesla Processing/cellvoltages_2022-07-15-17-03-11_T1-9_75.csv'
